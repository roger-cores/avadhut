...
public class Activate extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = ref.orderByChild("uid").equalTo(mAuth.getCurrentUser().getUid()).limitToFirst(1);
    ...
    public void onActivate(View v) {
        ...
        user1.setUid(mAuth.getCurrentUser().getUid());
        ...
        Log.d("CheckuidonClicked",mAuth.getCurrentUser().getUid());
        if (keyEditText.getText().toString().equals(mAuth.getCurrentUser().getUid())) {
            ...
            final DatabaseReference activeStated = ref.child(pushId);
