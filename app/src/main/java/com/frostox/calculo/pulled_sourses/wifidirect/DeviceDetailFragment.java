...
public class DeviceDetailFragment extends Fragment implements
				...
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (info.isGroupOwner)
							getWiFiDirectActivity().showSelectPeerDialog(); // ������ΪOwner�����ȴ���ѡ��Peer�߼���
						else {
	...
	public void onConnectionInfoAvailable(final WifiP2pInfo info) {
		...
		this.info = info;
		if(info.isGroupOwner) mContentView.findViewById(R.id.btn_start_client).setVisibility(View.GONE);
